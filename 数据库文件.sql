...
) ENGINE = InnoDB AUTO_INCREMENT = 1036 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (1000, 'novel', '巴黎圣母院', '9787560575667', '[法]雨果 著 李玉民 译', '西安交通大学出版社', '2015-08-01', '24170734-1_l_4.jpg', '北大西语系翻译家李玉民全译本，“世界十大名著”“世界十大爱情故事”之一，读过后，更懂爱', 37.80, 100, '2020-06-01 20:12:00');
INSERT INTO `book` VALUES (1001, 'novel', '失乐园', '9787555257035', '渡边淳一[著]  林少华[译]', '青岛出版社', '2017-11-01', '25182491-1_l_6.jpg', '渡边淳一代表作，长期雄踞日本畅销书排行榜榜首，由黑木瞳、役所广司主演的电影引发“失乐园”热。此次的全新林少华译本，将带你体味不一样的渡边淳一，不一样的失乐园。', 45.00, 100, '2020-06-01 20:12:00');
INSERT INTO `book` VALUES (1002, 'novel', '假面之夜+假面饭店+假面前夜', '25286485', '东野圭吾', '南海出版公司', '2018-06-01', '25286485-1_l_2.jpg', '新系列新CP。富丽堂皇的五星级大酒店，各怀心事的客人。平静的表面下暗流汹涌。杀人凶手即将在此现身。新田尚美联手揭开假面。', 115.90, 99, '2020-06-01 20:12:00');
...
INSERT INTO `book` VALUES (1014, 'sheke', '曾国藩的正面与侧面', '27856398', '张宏杰', '岳麓出版社', '2018-04-06', '27856398-1_l_4.jpg', '知名历史学者张宏杰，百万畅销《曾国藩的正面与侧面》经典系列，郑重收官。三本书分别阐述了中国特色官场生存哲学、治家典范书以及曾国藩领导力，展现一个更加立体的曾国藩。', 134.60, 100, '2020-06-01 20:12:00');
...
-- ----------------------------
INSERT INTO `order_item` VALUES (1, 1, 1002, 115.90, 1);
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, 2020001, '陈建池', '广东省云浮市', '527300', '13077533214', b'0', '2022-06-24 23:46:10');
...
-- ----------------------------
INSERT INTO `shopping_cart` VALUES (1, 2020001, 1002, 115.90, 1);
...
-- ----------------------------
INSERT INTO `user_info` VALUES (2020001, 'kirito', '123456', '2276022102@qq.com', '', '2022-06-24 23:45:34');
